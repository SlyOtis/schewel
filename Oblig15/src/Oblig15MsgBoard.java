...
public class Oblig15MsgBoard extends JPanel{
	...
	public Oblig15MsgBoard(){
		...
		roll = new JScrollBar(JScrollBar.VERTICAL,0,0,0,0);
		roll.addAdjustmentListener(new AdjustmentListener() {
			
			@Override
			public void adjustmentValueChanged(AdjustmentEvent e) {
				view.setViewPosition(new Point(display.getX(), e.getValue()));
			}
		});
	...
	private void addStatus(Status status){
    	...
    	roll.setMaximum(roll.getMaximum() + (post_height + post_spacing));
